...
saveRDS(full_corpus, "full_corpus.rds")
saveRDS(pro_corpus, "pro_corpus.rds")
saveRDS(contra_corpus, "contra_corpus.rds")
saveRDS(pro2000, "pro2000.rds")
saveRDS(contra2000, "contra2000")

# activists
saveRDS(fff_de_corpus, "fff_de_corpus.rds")
saveRDS(ikem_corpus, "ikem_corpus.rds")
saveRDS(klimarep_corpus, "klimarep_corpus.rds")
saveRDS(klimafakten_corpus, "klimafakten_corpus.rds")
saveRDS(zero_corpus, "zero_corpus.rds")
saveRDS(komma_corpus, "komma_corpus.rds")

# deniers
saveRDS(eike_corpus, "eike_corpus.rds")
saveRDS(ffh_corpus, "ffh_corpus.rds")
```
